...
import com.dengi.v.dolg.perkon.domain.model.AffSub1
import com.dengi.v.dolg.perkon.domain.model.AffSub2
import com.dengi.v.dolg.perkon.domain.model.AffSub3
import com.dengi.v.dolg.perkon.domain.model.AffSub5
...
class RepositoryAnalyticImpl @Inject constructor(
    ...
    private fun createPayloadAffsub1(
        ...
        appsflyer: String,
        firebaseToken: String
    ): String = "{\"AppMetricaDeviceID\":\"$appMetricaId\",\"Appsflyer\":\"$appsflyer\",\"FireBase\":\"$firebaseToken\",\"MyTracker\":\"$myTrackerId\"}"
